...
namespace OnlineMarket.Areas.Admin.Controllers
{
    ...
    public class AdminPostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,ShortContents,Contents,Thumb,Published,Alias,CreatedDate,Author,AccountId,Tags,CategoryId,IsHot,IsNewfeed,MetaKey,MetaDesc,Views")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Title,ShortContents,Contents,Thumb,Published,Alias,CreatedDate,Author,AccountId,Tags,CategoryId,IsHot,IsNewfeed,MetaKey,MetaDesc,Views")] Post post)
        {
            if (id != post.PostId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MarketDbContext.Posts'  is null.");
            }
            var post = await _context.Posts.FindAsync(id);
            if (post != null)
            {
